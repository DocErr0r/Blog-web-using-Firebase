    ...
    return (
        <section className=" py-8 lg:py-16">
          ...
          shadow-[inset_0_0_4px_rgba(0,0,0,0.6)] border border-gray-200 "
                        ...
                        <textarea id="comment" rows={6} value={commentText} onChange={(e) => setcommentText(e.target.value)} className="px-0 w-full text-sm border-0 focus:ring-0 focus:outline-none dark:text-white dark:placeholder-gray-400 " style={{ background: mode === 'dark' ? '#353b48' : 'rgb(226, 232, 240)' }} placeholder="Write a comment..." required defaultValue={''} />
                    </div>
                    {/* Button  */}
                    <div className="">
                        <button
